...
package com.webank.cert.mgr.component;
...
public class CertManager {
    ...
    public CertVO createChildCert(String userId, int csrId, boolean isCaCert, KeyUsage keyUsage) throws Exception {
        Date beginDate = new Date();
        Date endDate = new Date(beginDate.getTime() + 315360000000L);
        return this.createChildCert(userId, csrId, isCaCert, keyUsage, beginDate, endDate);
    }
